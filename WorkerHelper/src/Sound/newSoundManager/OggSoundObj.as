...
public class OggSoundObj extends ASoundObj implements ISound {
    ...
    private var OggEncodeWork:WorkPrimordialOggEncode;
    private function onComplete(e:Event = null):void
    {

        isOGGDecode = true;
        OggEncodeWork =  WorkFactory.creatWork(WorkFactory.WORK_OGG_ENCODE);
        OggEncodeWork.setEncodeBackFun(onAllComplete);
        OggEncodeWork.oggEncode(_urlLoader.data);
        /*if(!isOGGDecode)
        {
    ...
    private function onAllComplete(e:Event = null):void
    {
        trace("ogg   onAllComplete");
        isOGGDecode = false;
        oggSound.loadBytes(OggEncodeWork.DecodedBytes);

        //oggSound.loadBytes(oggEncode.decodedBytes);
        stepFun.callFun();
